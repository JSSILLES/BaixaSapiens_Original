...
namespace API_Baixa_Sapiens.Models
{
    ...
    {
        public TblFinanceira()
        {
            TblBaixaDivergencia = new HashSet<TblBaixaDivergencium>();
            TblDepositoJudicials = new HashSet<TblDepositoJudicial>();
        ...
        public int? NrSequencialLinhaBanco { get; set; }
        ...
        public virtual TblStatusFinanceiro? SqStatusFinanceiroNavigation { get; set; }
        public virtual TblTipoArrecadacao SqTipoArrecadacaoNavigation { get; set; } = null!;
        public virtual ICollection<TblBaixaDivergencium> TblBaixaDivergencia { get; set; }
        public virtual ICollection<TblDepositoJudicial> TblDepositoJudicials { get; set; }
