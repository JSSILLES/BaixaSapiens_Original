namespace API_Baixa_Sapiens.Controller
{
    public class ClassBKP
{
        ...
        //        }
        //        string jsonResult = JsonSerializer.Serialize(new { convertedFilePath = arquivoScriptPath });
